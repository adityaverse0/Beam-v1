...
class _Translations$networkInterfacesPage$uz extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Standart holatda Beam barcha mavjud tarmoq interfeyslaridan foydalanadi. Bu yerda keraksiz tarmoqlarni chiqarib tashlashingiz mumkin. Oʻzgarishlarni qoʻllash uchun serverni qayta ishga tushirishingiz kerak.';
  @override
...
class _Translations$receiveOptionsPage$uz extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Beam papkasi)';
  @override
...
class _Translations$webSharePage$uz extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Beam oʻz-oʻzini imzolagan sertifikatdan foydalanadi. Uni brauzeringizda qabul qilishingiz kerak.';
  @override
...
class _Translations$aboutPage$uz extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Beam haqida';
  @override
  List<String> get description => [
    'Beam — bu bepul, ochiq manbali ilova boʻlib, u internet ulanishisiz mahalliy tarmoq orqali yaqin atrofdagi qurilmalar bilan fayllar va xabarlarni xavfsiz ulashish imkonini beradi.',
...
class _Translations$donationPage$uz extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Beam bepul, ochiq manbali va reklamasiz. Agar ilova sizga yoqqan boʻlsa, xayriya bilan rivojlanishni qoʻllab-quvvatlashingiz mumkin.';
  @override
...
class _Translations$tray$uz extends Translations$tray$en {
  ...
  @override
  String get close => 'Beamdan chiqish';
  @override
...
class _Translations$settingsTab$general$uz extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Beamni kontekst menyusida koʻrsatish';
  @override
...
class _Translations$settingsTab$other$uz extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Beamni qoʻllab-quvvatlash';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$uz extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Beam mahalliy tarmoqni skanerlash ruxsatisiz boshqa qurilmalarni topa olmaydi. Iltimos, ushbu ruxsatni sozlamalarda bering.';
  @override
...
class _Translations$dialogs$sendModeHelp$uz extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Beam oʻrnatilmagan qabul qiluvchilar havolani brauzerlarida ochish orqali tanlangan fayllarni yuklab olishlari mumkin.';
}
