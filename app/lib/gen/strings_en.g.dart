...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, Beam uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, Beam uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$webSharePage$en {
  ...
  /// en: 'Beam uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'Beam uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$donationPage$en {
  ...
  /// en: 'Beam is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'Beam is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show Beam in context menu'
  String get showInContextMenu => 'Show Beam in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support Beam'
  String get support => 'Support Beam';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'Beam can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'Beam can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have Beam installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have Beam installed can download the selected files by opening the link in their browser.';
}
